...
export default function Dashboard(){
    ...
    const getMyStories = async () => {
        try {
            const stories = await axios(`/stories/mystories/${userContext[0].user_id}`)
    ...
    const getMostViewedStories = async () => {
        try {
            const stories = await axios("/stories/mostviewed")
    ...
    const getNewestStories = async () => {
        try {
            const stories = await axios("/stories/neweststories")
